...
class FixedBackground:
    ...
    def __init__(self):
        self.image = load_image('court4.png')
    ...
    def update(self):
        # fill here
        self.window_left = int(server.character.x) - self.cw // 2
        self.window_bottom = int(server.character.y) - self.ch // 2
...
class InfiniteBackground:
    ...
    def update(self):
        # quadrant 3
        self.q3l = (int(server.character.x) - self.cw // 2) % self.w
        self.q3b = (int(server.character.y) - self.ch // 2) % self.h
